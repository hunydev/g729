...
- [x] **Step 1: Write failing test** `TestEncode_LSPVectorBitExact` that:
...
- [x] **Step 2: Run to verify FAIL** initially (`undefined: (*Encoder).lpcStep` and `errStub`-shaped Analyze).
- [x] **Step 3: Write minimal implementation:**
