...
//	    tables.PitchInterpFIR for fractional offsets. Short-pitch
//	    reconstruction, including tFrac == 0, evaluates current-subframe
//	    taps from previously generated adaptive-vector samples.
//
